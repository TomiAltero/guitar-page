...
class IndexView(View):
    def get(self, request):
        ...
        print(silver_collection)


        return render(request, "index.html", {'silver_collection': silver_collection, 'fender_guitars': fender_guitars, 'strat_american_special': strat_american_special})
